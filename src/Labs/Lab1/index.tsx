...
tag to tell browsers to render the gaps.
  ...
  <ol id="wd-your-favorite-recipe">
    <li>Boil and cool down the milk.</li>
    <li>Boil the rose petals in water and get the essence.</li>
    <li>Stir to combine.</li>
    <li>Add sugar or condensed milk.</li>
    <li>Enjoy the rose milk with ice cubes.</li>
  </ol>
</div>
...
<ul id="wd-your-books">
  <li>A little Life</li>
  <li>Black suits you</li>
  <li>A kiss in the rain</li>
...
<div id="wd-forms">
  ...
  <form id="wd-text-fields">
    ...
    <input placeholder="RVL" id="wd-text-fields-username" /> <br />
    <label htmlFor="wd-text-fields-password">Password:</label>
    <input type="password" defaultValue="123@#$asd" id="wd-text-fields-password" />
    <br />
    <label htmlFor="wd-text-fields-first-name">First name:</label>
    <input type="text" title="Roshan" id="wd-text-fields-first-name" /> <br />
    <label htmlFor="wd-text-fields-last-name">Last name:</label>
    <input type="text" placeholder="Doe"
           defaultValue="Venkatesh Lavanya"
           title="The last name"
...
<input type="email"
       placeholder="roshanvl810@gmail.com"
...
<a href="https://github.com/roshan-venkatesh-lavanya?tab=repositories" id="wd-github">click here</a>
for GIT<br/>
    </div>
