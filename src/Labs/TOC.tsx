...
export default function TOC() {
  ...
  return (
    ...
    <Nav.Item> <Nav.Link as={Link} to="/Labs/Lab5" id="wd-5"
          active={pathname.includes("Lab5")}> Lab 5</Nav.Link> </Nav.Item>
      <Nav.Item> <Nav.Link as={Link} to="/Kambaz" id="wd-ak">Kambaz </Nav.Link> </Nav.Item>
      <Nav.Item> <Nav.Link href="https://github.com/roshan-venkatesh-lavanya" target="_blank"> My GitHub </Nav.Link> </Nav.Item>
    </Nav>
  );
}